...
export default function Contact() {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      icon: <FaLinkedin />,
      url: "https://www.linkedin.com/in/shoukat-rai-750507245/",
      color: "text-[#0077B5]",
    },
    {
      name: "GitHub",
      icon: <FaGithub />,
      url: "https://github.com/shoukatrai",
      color: "text-gray-900 dark:text-white",
    },
    {
      name: "Fiverr",
      icon: <SiFiverr />,
      url: "https://www.fiverr.com/shoukatrai",
      color: "text-[#1dbf73]",
    },
    {
      name: "WhatsApp",
      icon: <FaWhatsapp />,
      url: "https://wa.me/923473127706",
      color: "text-[#25D366]",
    },
    {
      name: "Facebook",
      icon: <FaFacebook />,
      url: "https://www.facebook.com/shoukat.umedani",
      color: "text-[#1877F2]",
    },
  ];
  ...
  return (
    <section
      id="contact"
      className="py-20 px-6 bg-white dark:bg-gray-950 transition-colors"
    >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white dark:bg-gray-800 border dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 outline-none dark:text-white transition-all"
                />
              </div>
              <div>
                <label className="block text-sm font-medium mb-2 dark:text-gray-300">
