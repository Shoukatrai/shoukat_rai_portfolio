...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center px-6 pt-28 pb-16 overflow-hidden relative"
    >
      ...
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center gap-12 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-gray-950 dark:text-white leading-[1.15] tracking-tight">
            ...
            <span className="block text-3xl md:text-5xl text-gray-800 dark:text-gray-200 mt-2">
              MERN Stack Developer
            </span>
          </h1>

          <p className="mt-6 text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-2xl leading-relaxed">
            A passionate MERN Stack Developer trained at SMIT. I specialize in
            crafting modern, highly responsive, and user-centric web
            applications. Currently, I am leveraging Next.js to build
            performance-optimized, SEO-friendly solutions that bridge the gap
            between complex requirements and elegant UX.
          </p>
